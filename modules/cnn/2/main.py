...
model = keras.Sequential([
  keras.layers.Conv1D(32, 4, strides=1, activation='relu', input_shape=(2000,2), batch_size=400),
  keras.layers.BatchNormalization(),
  keras.layers.MaxPooling1D(2, 2),
  keras.layers.Conv1D(64, 4, strides=1, activation='relu'),
  keras.layers.BatchNormalization(),
  keras.layers.MaxPooling1D(2, 2),
  keras.layers.UpSampling1D(2),
  keras.layers.Conv1D(96, 4, strides=1, activation='relu'),
  keras.layers.BatchNormalization(),
